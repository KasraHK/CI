#!/usr/bin/env python3
"""
Simple web-based visualization system for benchmark experiment results
Creates interactive HTML pages with tables (without plotly dependency)
"""
...
class SimpleWebVisualizer:
    ...
    def create_function_info_dataframe(self, functions):
        ...
        for func_name in functions:
            ...
            # Get the actual dimension used in experiments
