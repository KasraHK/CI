...
BENCHMARK_FUNCTIONS = {
    ...
    "schaffer_n2":        {"func": schaffer_n2, "bounds": (-100, 100), "type": "unimodal", "dim_type": 2},
    "schaffer_n3":        {"func": schaffer_n3, "bounds": (-100, 100), "type": "unimodal", "dim_type": 2},
    "schaffer_n4":        {"func": schaffer_n4, "bounds": (-100, 100), "type": "unimodal", "dim_type": 2},
    "schwefel_2_20":      {"func": schwefel_2_20, "bounds": (-100, 100), "type": "unimodal", "dim_type": "n-dim"},
    ...
    "xinsheyang_n3":      {"func": xinsheyang_n3, "bounds": (-2*np.pi, 2*np.pi), "type": "unimodal", "dim_type": "n-dim"},
    ...
    "rastrigin":          {"func": rastrigin, "bounds": (-5.12, 5.12), "type": "multimodal", "dim_type": "n-dim"},
    "rosenbrock":         {"func": rosenbrock, "bounds": (-5, 10), "type": "multimodal", "dim_type": "n-dim"}, # Moved to multimodal as per list
    "salomon":            {"func": salomon, "bounds": (-100, 100), "type": "multimodal", "dim_type": "n-dim"},
